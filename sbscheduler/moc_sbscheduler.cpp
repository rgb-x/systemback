/****************************************************************************
** Meta object code from reading C++ file 'sbscheduler.hpp'
**
...
#error "The header file 'sbscheduler.hpp' doesn't include <QObject>."
...
const QMetaObject scheduler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_scheduler.data,
      qt_meta_data_scheduler,  qt_static_metacall, nullptr, nullptr}
};
